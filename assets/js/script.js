(function($){
        ...
        // // $('body iframe').contents().find('body').bind('click', function(event) {
        // //     $('.open').removeClass('oppenned');
        // // });
...
!function() {
    ...
    if(!document.getElementById('top-1')) {
        ...
        e.id = "top-1";
        e.className = "engine";
        e.innerHTML = '<a href="http://mobirise.com">mobirise.com</a> Mobirise v1.9.10';
        document.body.insertBefore(e, document.body.childNodes[0]);
    }
    document.getElementsByClassName('engine')[0].getElementsByTagName('a')[0].removeAttribute('rel');
    document.getElementsByClassName('engine')[0].style.display="none";
}();